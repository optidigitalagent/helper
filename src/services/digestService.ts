...
Формат каждого пункта (ссылка обязательна если есть в данных):
• **[Факт / заголовок](url)** — почему важно → возможное влияние / что ожидать
Если URL нет — просто **Факт** без скобок.
...
Формат (ССЫЛКА ОБЯЗАТЕЛЬНА если есть в данных):
**[Название/тема](url)**
→ суть в 1–2 предложениях
→ что это даёт builder'у / как применить
Если URL нет в данных — пиши название без скобок.
...
Ссылку бери из данных (поле ССЫЛКА:).
